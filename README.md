## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `FastAPI`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the FastAPI API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Fast                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | datalab-to                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | FastConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | FastRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Fast.Client    | use the "dispatch" functions to send requests       |
| Fast.Core      | core functions, config and request types            |
| Fast.API       | construct api requests                              |
| Fast.Model     | describes api models                                |
| Fast.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Fast.ModelLens | lenses for model fields                             |
| Fast.Logging   | logging functions and utils                         |
